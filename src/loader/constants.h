...
#define PRODUCT             "Civ 2 MGE Patch Loader"
#define DESCRIPTION         "Civilization 2 Multiplayer Gold Edition Patch Loader"
#define MODULE_NAME         "civ2patch.exe"
#define UAC_MANIFEST_FILE   "manifest.xml"
